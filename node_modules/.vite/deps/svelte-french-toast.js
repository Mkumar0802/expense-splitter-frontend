...
function add_css3(target) {
  append_styles(target, "svelte-1j7dflg", "div.svelte-1j7dflg{width:12px;height:12px;box-sizing:border-box;border:2px solid;border-radius:100%;border-color:var(--secondary, #e0e0e0);border-right-color:var(--primary, #616161);animation:svelte-1j7dflg-rotate 1s linear infinite}@keyframes svelte-1j7dflg-rotate{from{transform:rotate(0deg)}to{transform:rotate(360deg)}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function add_css4(target) {
  append_styles(target, "svelte-1kgeier", ".indicator.svelte-1kgeier{position:relative;display:flex;justify-content:center;align-items:center;min-width:20px;min-height:20px}.status.svelte-1kgeier{position:absolute}.animated.svelte-1kgeier{position:relative;transform:scale(0.6);opacity:0.4;min-width:20px;animation:svelte-1kgeier-enter 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards}@keyframes svelte-1kgeier-enter{from{transform:scale(0.6);opacity:0.4}to{transform:scale(1);opacity:1}}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function instance4($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("toast" in $$props2) $$invalidate(3, toast2 = $$props2.toast);
  };
  $$self.$capture_state = () => ({
  ...
  $$self.$inject_state = ($$props2) => {
    if ("toast" in $$props2) $$invalidate(3, toast2 = $$props2.toast);
    if ("iconTheme" in $$props2) $$invalidate(0, iconTheme = $$props2.iconTheme);
...
function add_css5(target) {
  append_styles(target, "svelte-1nauejd", ".message.svelte-1nauejd{display:flex;justify-content:center;margin:4px 10px;color:inherit;flex:1 1 auto;white-space:pre-line}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
  ...
  const block = {
    ...
    p: function update2(ctx2, dirty) {
      ...
      ctx2[0].message)) {
        ...
        if (dirty & /*toast*/
        1) switch_instance_changes.toast = /*toast*/
        ctx2[0];
...
function create_if_block2(ctx) {
  ...
  const block = {
    ...
    p: function update2(ctx2, dirty) {
      ...
      ctx2[0].message + "")) set_data_dev(t, t_value);
    },
    i: noop,
    o: noop,
    d: function destroy(detaching) {
...
function create_fragment5(ctx) {
  ...
  function select_block_type(ctx2, dirty) {
    if (typeof /*toast*/
    ctx2[0].message === "string") return 0;
    return 1;
  }
...
function instance5($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("toast" in $$props2) $$invalidate(0, toast2 = $$props2.toast);
  };
...
function fallback_block(ctx) {
  ...
  const block = {
    ...
    p: function update2(ctx2, dirty) {
      ...
      if (dirty & /*toast*/
      1) toasticon_changes.toast = /*toast*/
      ctx2[0];
      toasticon.$set(toasticon_changes);
      const toastmessage_changes = {};
      if (dirty & /*toast*/
      1) toastmessage_changes.toast = /*toast*/
      ctx2[0];
...
function instance6($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("toast" in $$props2) $$invalidate(0, toast2 = $$props2.toast);
    if ("position" in $$props2) $$invalidate(5, position = $$props2.position);
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("style" in $$props2) $$invalidate(1, style = $$props2.style);
    if ("Component" in $$props2) $$invalidate(2, Component = $$props2.Component);
    if ("factor" in $$props2) $$invalidate(3, factor = $$props2.factor);
...
function add_css7(target) {
  append_styles(target, "svelte-v01oml", ".wrapper.svelte-v01oml{left:0;right:0;display:flex;position:absolute;transform:translateY(calc(var(--offset, 16px) * var(--factor) * 1px))}.transition.svelte-v01oml{transition:all 230ms cubic-bezier(0.21, 1.02, 0.73, 1)}.active.svelte-v01oml{z-index:9999}.active.svelte-v01oml>*{pointer-events:auto}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function fallback_block2(ctx) {
  ...
  const block = {
    ...
    p: function update2(ctx2, dirty) {
      ...
      if (dirty & /*toast*/
      1) toastbar_changes.toast = /*toast*/
      ctx2[0];
      if (dirty & /*toast*/
      1) toastbar_changes.position = /*toast*/
      ctx2[0].position;
...
function instance7($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("toast" in $$props2) $$invalidate(0, toast2 = $$props2.toast);
    if ("setHeight" in $$props2) $$invalidate(6, setHeight = $$props2.setHeight);
    if ("$$scope" in $$props2) $$invalidate(7, $$scope = $$props2.$$scope);
  };
  $$self.$capture_state = () => ({
    onMount,
  ...
  $$self.$inject_state = ($$props2) => {
    if ("toast" in $$props2) $$invalidate(0, toast2 = $$props2.toast);
    if ("setHeight" in $$props2) $$invalidate(6, setHeight = $$props2.setHeight);
    if ("wrapperEl" in $$props2) $$invalidate(1, wrapperEl = $$props2.wrapperEl);
    if ("justifyContent" in $$props2) $$invalidate(2, justifyContent = $$props2.justifyContent);
    if ("factor" in $$props2) $$invalidate(3, factor = $$props2.factor);
...
function add_css8(target) {
  append_styles(target, "svelte-1phplh9", ".toaster.svelte-1phplh9{--default-offset:16px;position:fixed;z-index:9999;top:var(--default-offset);left:var(--default-offset);right:var(--default-offset);bottom:var(--default-offset);pointer-events:none}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
...
function create_each_block(key_1, ctx) {
  ...
  const block = {
    ...
    p: function update2(new_ctx, dirty) {
      ...
      if (dirty & /*_toasts*/
      4) toastwrapper_changes.toast = /*toast*/
      ctx[11];
      if (dirty & /*_toasts*/
      4) toastwrapper_changes.setHeight = func;
...
function instance8($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("reverseOrder" in $$props2) $$invalidate(5, reverseOrder = $$props2.reverseOrder);
    if ("position" in $$props2) $$invalidate(6, position = $$props2.position);
    if ("toastOptions" in $$props2) $$invalidate(7, toastOptions = $$props2.toastOptions);
    if ("gutter" in $$props2) $$invalidate(8, gutter = $$props2.gutter);
    if ("containerStyle" in $$props2) $$invalidate(0, containerStyle = $$props2.containerStyle);
    if ("containerClassName" in $$props2) $$invalidate(1, containerClassName = $$props2.containerClassName);
  };
  $$self.$capture_state = () => ({
    useToaster,
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("containerStyle" in $$props2) $$invalidate(0, containerStyle = $$props2.containerStyle);
    if ("containerClassName" in $$props2) $$invalidate(1, containerClassName = $$props2.containerClassName);
    if ("_toasts" in $$props2) $$invalidate(2, _toasts = $$props2._toasts);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
